...
amp = 3; %from 5 to 3
Fs = 48000;
dur = 23; % in seconds or 23 for functional 
time = (1 : dur * Fs);
phase = 0;
...
if num_chans == 6
    testplay0 = [x_zeros; x_zeros; x_zeros; x_zeros; x_zeros; x_zeros];
    testplay1 = [x; x; x; x; x; x];
    testplay2 = [x; x; x; x; x; x];
    testplay3 = [x; x; x; x; x; x];
    testplay4 = [x; x; x; x; x; x];
    testplay5 = [x; x; x; x; x; x];
    testplay6 = [x; x; x; x; x; x];
else
end


testplay7 = [x; x; x; x; x; x];
